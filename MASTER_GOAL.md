# MASTER_GOAL.md — ask-tools

## Purpose

This is the **master goal** for building ask-tools. It does not implement the gem
directly. It loads and follows the detailed build plan at:

> **GOAL.md:** `/Users/kaka/Code/ask-rb/ask-tools/GOAL.md`
...
- **Source:** `/Users/kaka/Code/ask-rb/ask-tools/lib/`
- **Tests:** `/Users/kaka/Code/ask-rb/ask-tools/test/`
- **Goal:** `/Users/kaka/Code/ask-rb/ask-tools/GOAL.md`
- **Remote:** `git@github.com:ask-rb/ask-tools.git`
- **RubyLLM Tool base class:** /Users/kaka/Code/ask-rb/ruby_llm/lib/ruby_llm/tool.rb
...
The GOAL.md at `/Users/kaka/Code/ask-rb/ask-tools/GOAL.md` contains the full
...
See the bottom of `/Users/kaka/Code/ask-rb/ask-tools/GOAL.md` for the full checklist.
